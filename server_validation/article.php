...
<body>
  ...
  <div class="container">
    <div class="width-8">
      ...
      <form method="post">
            <div>
                <button type="submit" class="button warning" formaction="edit_story_form.php">Update</button>
                <button type="submit" class="button danger" formaction="delete_story_form.php">Delete</button>
            </div>
